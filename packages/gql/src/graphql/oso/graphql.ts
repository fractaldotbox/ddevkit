...
export type CodeMetricsByProjectQueryVariables = Exact<{
  where: Oso_CodeMetricsByProjectV1BoolExp;
}>;


export type CodeMetricsByProjectQuery = { __typename?: 'Query', oso_codeMetricsByProjectV1?: Array<{ __typename?: 'Oso_CodeMetricsByProjectV1', projectId: string, projectName: string, displayName: string, activeDeveloperCount6Months: any, closedIssueCount6Months: any, commentCount6Months: any, commitCount6Months: any, contributorCount: any, contributorCount6Months: any, developerCount: any, eventSource: string, forkCount: any, fulltimeDeveloperAverage6Months: any, lastCommitDate: any, lastUpdatedAtDate: any, mergedPullRequestCount6Months: any, newContributorCount6Months: any, openedIssueCount6Months: any, openedPullRequestCount6Months: any, projectNamespace: string, projectSource: string, releaseCount6Months: any, repositoryCount: any, starCount: any }> | null };
...
export const CodeMetricsByProjectDocument = new TypedDocumentString(`
  ...
  oso_codeMetricsByProjectV1(where: $where) {
    ...
    `) as unknown as TypedDocumentString<CodeMetricsByProjectQuery, CodeMetricsByProjectQueryVariables>;