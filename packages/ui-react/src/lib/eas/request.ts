import { Signature } from "./sdk/offchain/typed-data-handler";
...
export interface DelegatedProxyAttestationRequest
	extends DelegatedAttestationRequest {}
export interface MultiDelegatedProxyAttestationRequest
	extends MultiDelegatedAttestationRequest {}
export interface DelegatedProxyRevocationRequest
	extends DelegatedRevocationRequest {}
export interface MultiDelegatedProxyRevocationRequest
	extends MultiDelegatedRevocationRequest {}
