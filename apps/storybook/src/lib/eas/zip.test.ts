...
import { zlibSync, deflateSync, inflateSync, unzlibSync } from 'fflate';
...
describe("zip", ()=>{
    ...
    const fixtures = [
        ...
        {
            unequalOutput: 'fsjdkal;fjldskfkjfldasfjfkldsjldjfsfsdjkljdlfjsdkfjdslfjdskfj'
        }
    ]
    test.each(fixtures)('pako fflate compatability', (fixture)=>{
        ...
        expect(pako.inflateRaw(fflateDeflate, {to:'string'})).toEqual(fixtureString);
